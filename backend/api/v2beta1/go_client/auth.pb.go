...
func (AuthorizeRequest_Resources) Descriptor() protoreflect.EnumDescriptor {
	return file_backend_api_v2beta1_auth_proto_enumTypes[0].Descriptor()
}

func (AuthorizeRequest_Resources) Type() protoreflect.EnumType {
	return &file_backend_api_v2beta1_auth_proto_enumTypes[0]
}
...
func (AuthorizeRequest_Resources) EnumDescriptor() ([]byte, []int) {
	return file_backend_api_v2beta1_auth_proto_rawDescGZIP(), []int{0, 0}
}
...
func (AuthorizeRequest_Verb) Descriptor() protoreflect.EnumDescriptor {
	return file_backend_api_v2beta1_auth_proto_enumTypes[1].Descriptor()
}

func (AuthorizeRequest_Verb) Type() protoreflect.EnumType {
	return &file_backend_api_v2beta1_auth_proto_enumTypes[1]
}
...
func (AuthorizeRequest_Verb) EnumDescriptor() ([]byte, []int) {
	return file_backend_api_v2beta1_auth_proto_rawDescGZIP(), []int{0, 1}
}
...
type AuthorizeRequest struct {
	...
	Resources     AuthorizeRequest_Resources `protobuf:"varint,2,opt,name=resources,proto3,enum=kubeflow.pipelines.backend.api.v2beta1.AuthorizeRequest_Resources" json:"resources,omitempty"` // Resource type asking for authorization.
	Verb          AuthorizeRequest_Verb      `protobuf:"varint,3,opt,name=verb,proto3,enum=kubeflow.pipelines.backend.api.v2beta1.AuthorizeRequest_Verb" json:"verb,omitempty"`                // Verb on the resource asking for authorization.
...
func (x *AuthorizeRequest) Reset() {
	*x = AuthorizeRequest{}
	mi := &file_backend_api_v2beta1_auth_proto_msgTypes[0]
...
func (*AuthorizeRequest) Descriptor() ([]byte, []int) {
	return file_backend_api_v2beta1_auth_proto_rawDescGZIP(), []int{0}
}
...
var File_backend_api_v2beta1_auth_proto protoreflect.FileDescriptor
...
var (
	file_backend_api_v2beta1_auth_proto_rawDescOnce sync.Once
	file_backend_api_v2beta1_auth_proto_rawDescData []byte
)

func file_backend_api_v2beta1_auth_proto_rawDescGZIP() []byte {
	file_backend_api_v2beta1_auth_proto_rawDescOnce.Do(func() {
	...
	return file_backend_api_v2beta1_auth_proto_rawDescData
}

var file_backend_api_v2beta1_auth_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_backend_api_v2beta1_auth_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_backend_api_v2beta1_auth_proto_goTypes = []any{
	(AuthorizeRequest_Resources)(0), // 0: kubeflow.pipelines.backend.api.v2beta1.AuthorizeRequest.Resources
	(AuthorizeRequest_Verb)(0),      // 1: kubeflow.pipelines.backend.api.v2beta1.AuthorizeRequest.Verb
	(*AuthorizeRequest)(nil),        // 2: kubeflow.pipelines.backend.api.v2beta1.AuthorizeRequest
	(*emptypb.Empty)(nil),           // 3: google.protobuf.Empty
}
var file_backend_api_v2beta1_auth_proto_depIdxs = []int32{
	0, // 0: kubeflow.pipelines.backend.api.v2beta1.AuthorizeRequest.resources:type_name -> kubeflow.pipelines.backend.api.v2beta1.AuthorizeRequest.Resources
	1, // 1: kubeflow.pipelines.backend.api.v2beta1.AuthorizeRequest.verb:type_name -> kubeflow.pipelines.backend.api.v2beta1.AuthorizeRequest.Verb
	2, // 2: kubeflow.pipelines.backend.api.v2beta1.AuthService.Authorize:input_type -> kubeflow.pipelines.backend.api.v2beta1.AuthorizeRequest
	3, // 3: kubeflow.pipelines.backend.api.v2beta1.AuthService.Authorize:output_type -> google.protobuf.Empty
...
func init() { file_backend_api_v2beta1_auth_proto_init() }
func file_backend_api_v2beta1_auth_proto_init() {
	if File_backend_api_v2beta1_auth_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_backend_api_v2beta1_auth_proto_goTypes,
		DependencyIndexes: file_backend_api_v2beta1_auth_proto_depIdxs,
		EnumInfos:         file_backend_api_v2beta1_auth_proto_enumTypes,
		MessageInfos:      file_backend_api_v2beta1_auth_proto_msgTypes,
	}.Build()
	File_backend_api_v2beta1_auth_proto = out.File
	file_backend_api_v2beta1_auth_proto_goTypes = nil
	file_backend_api_v2beta1_auth_proto_depIdxs = nil
}
